...
export class GameLauncher {
    ...
    launch(id) {
        ...
        backBtn.innerHTML = '<span aria-hidden="true" class="material-symbols-rounded">arrow_back</span> Back to Menu';
        ...
        if (id === 'snake') {
            ...
            controls.innerHTML = `
                <div></div>
                <button class="snake-btn" data-dir="up" type="button" aria-label="Move up" title="Move up"><span aria-hidden="true" class="material-symbols-rounded">keyboard_arrow_up</span></button>
                <div></div>
                <button class="snake-btn" data-dir="left" type="button" aria-label="Move left" title="Move left"><span aria-hidden="true" class="material-symbols-rounded">keyboard_arrow_left</span></button>
                <button class="snake-btn" data-dir="down" type="button" aria-label="Move down" title="Move down"><span aria-hidden="true" class="material-symbols-rounded">keyboard_arrow_down</span></button>
                <button class="snake-btn" data-dir="right" type="button" aria-label="Move right" title="Move right"><span aria-hidden="true" class="material-symbols-rounded">keyboard_arrow_right</span></button>
            `;
