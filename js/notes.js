            ...
            div.innerHTML = `
                <div class="note-top">
                    ...
                    <div class="note-badges">
                        ...
                        ${n.src === 'local' && this.isAuthed() ? `<button class="note-del" data-id="${n.id}" title="Delete note" aria-label="Delete note"><span class="material-symbols-rounded">delete</span></button>` : ''}
                    </div>
                </div>
